...
namespace ttl
{
    ...
    class BBTreeReverseIterator
    {
        typedef BBTreeNode<T, t> Node;
        typedef BBTreeReverseIterator<T, t> iterator;
    public:
        BBTreeReverseIterator() : m_pointer(nullptr), m_offset(0) {}
        BBTreeReverseIterator(Node * pointer, int offset) : m_pointer(pointer), m_offset(offset) {}
        ~BBTreeReverseIterator() {}
