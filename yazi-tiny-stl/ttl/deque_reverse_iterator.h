...
namespace ttl
{
    ...
    class DequeReverseIterator
    {
        ...
        typedef DequeReverseIterator<T, N> iterator;
    public:
        DequeReverseIterator() : m_pointer(nullptr), m_offset(0) {}
        DequeReverseIterator(Node ** pointer, int offset) : m_pointer(pointer), m_offset(offset) {}
