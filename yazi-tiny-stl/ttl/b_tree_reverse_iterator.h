...
namespace ttl
{
    ...
    class BTreeReverseIterator
    {
        ...
        typedef BTreeReverseIterator<T, t> iterator;
    public:
        BTreeReverseIterator() : m_pointer(nullptr), m_offset(0) {}
        BTreeReverseIterator(Node * pointer, int offset) : m_pointer(pointer), m_offset(offset) {}
        ~BTreeReverseIterator() {}
