...
namespace ttl
{
    ...
    class TreeReverseIterator
    {
        ...
        typedef TreeReverseIterator<T> iterator;
    public:
        TreeReverseIterator() : m_root(nullptr), m_pointer(nullptr) {}
        TreeReverseIterator(Node * root, Node * pointer) : m_root(root), m_pointer(pointer) {}
        ~TreeReverseIterator() {}
