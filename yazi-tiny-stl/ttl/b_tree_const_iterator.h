...
namespace ttl
{
    ...
    class BTreeConstIterator
    {
        ...
        typedef BTreeConstIterator<T, t> iterator;
    public:
        BTreeConstIterator() : m_pointer(nullptr), m_offset(0) {}
        BTreeConstIterator(Node * pointer, int offset) : m_pointer(pointer), m_offset(offset) {}
        ~BTreeConstIterator() {}
